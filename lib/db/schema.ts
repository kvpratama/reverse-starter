...
export const jobPostsCandidate = pgTable(
  "job_posts_candidate",
  {
    ...
    similarityScoreBio: integer("similarity_score_bio"),
    similarityScoreSkills: integer("similarity_score_skills"),
    similarityScoreScreening: integer("similarity_score_screening"),
