...
const JobCategorySelector: React.FC = () => {
  ...
  return (
    <div className="mx-auto border border-gray-300 p-6 bg-white rounded-xl shadow-md">
      <div className="mb-6">
        <h2 className="text-2xl text-gray-900 mb-2">Select Your Job Category</h2>
        <p className="text-gray-600">Choose the category that best matches your professional role</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="flex flex-col">
          ...
          <CustomSelect
            ...
            placeholder={selectedCategory ? "Select a subcategory..." : "First select a primary category"}
        ...
        <div className="flex flex-col">
          ...
          <CustomSelect
            ...
            placeholder={selectedSubcategory ? "Select your specific role..." : "First select a subcategory"}
