                ...
                <FormSection title="Company Information" icon={Building2}>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <InputField
                      ...
                      defaultValue={
                        state?.companyName ?? jobPost?.companyName ?? ""
                      }
                      required
                      disabled={disabled}
                    />
                    <InputField
                      ...
                      defaultValue={
                        state?.location ?? jobPost?.jobLocation ?? ""
                      }
                      required
                      disabled={disabled}
                    />
                  ...
                  <InputField
                    ...
                    defaultValue={
                      state?.companyProfile ?? jobPost?.companyProfile ?? ""
                    }
                    component="textarea"
                    rows={6}
                    required
              ...
              <CardContent className="p-8">
                <FormSection title="Job Details" icon={FileText}>
                  ...
                  <InputField
                    ...
                    defaultValue={
                      state?.description ?? jobPost?.jobDescription ?? ""
                    }
                    component="textarea"
                    rows={8}
                    required
                  ...
                  <InputField
                    ...
                    defaultValue={
                      state?.requirements ?? jobPost?.jobRequirements ?? ""
                    }
                    component="textarea"
                    rows={8}
                    required
