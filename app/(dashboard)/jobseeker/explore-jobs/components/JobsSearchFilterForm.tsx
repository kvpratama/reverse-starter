...
export default function JobsSearchFilterForm({
  ...
  const [minSalaryValue, setMinSalaryValue] = useState(searchParams.minSalary || '');
  const [maxSalaryValue, setMaxSalaryValue] = useState(searchParams.maxSalary || '');
  ...
  const filteredSubcategories = selectedCategory
    ? filterOptions.subcategories.filter(sub => sub.categoryId === selectedCategory)
    : [];
